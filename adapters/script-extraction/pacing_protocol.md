...
### 6.3 与 yang-shoot 的协同

| 维度 | pacing_analyzer | yang-shoot |
|------|----------------|------------|
| 关注点 | 物理节奏（气口/语速） | 镜头节奏（景别/切换/运镜） |
| 输入 | 文稿文本（+可选音频时间戳） | 文稿 + 分镜脚本 + 拍摄清单 |
| 输出 | 气口标注 + 语速分析 + 节奏建议 | 分镜方案 + 镜头时长 + 切换点 |
| 冲突点 | 无 | 无 |

**协同流程**：
1. 气口位置驱动镜头切换：自然停顿对应常规切换点，强调停顿对应重点景别切换，情绪停顿对应情绪镜头切换
2. 语速段匹配镜头时长：快语速段适合短镜头快切，慢语速段适合长镜头慢推，正常语速适合中景固定
3. 换气停顿可作为 B-roll 插入点，在不打断主叙事的前提下补充画面信息
4. 节奏健康度评分指导整体剪辑节奏：评分低则镜头节奏需重构，评分高则按气口/语速自然切分
5. 两者结合形成"声画节奏"：气口/语速是声音节奏，镜头切换是画面节奏，声画对齐提升观感
