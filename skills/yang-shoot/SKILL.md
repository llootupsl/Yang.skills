...
本 skill 与以下知识库文件形成正向联动（详见 [`knowledge/_linkage-map.md`](../../knowledge/_linkage-map.md) 通道 5：拍摄登记联动）：

- `knowledge/ansir/audiovisual.md`：导演级视听语言系统（四层结构、叙事层六要素、空间架构、时间控制、时间的语法、摄影机七种运动、影像八体、行动日历），作为拍摄登记的**视听语言理论指导**
- `knowledge/xuehui/shooting-editing.md`：拍摄及呈现体系（运镜7种、景别、构图、六种打光、剪辑五步骤），作为拍摄登记的**拍摄剪辑实操指导**

### 联动方式

将 `ansir/audiovisual.md` 的导演级视听语言系统作为拍摄登记的**视听语言理论指导**，在改稿检测时辅助判断脚本中的视听元素是否在拍摄中得到保留；将 `xuehui/shooting-editing.md` 的拍摄及呈现体系作为拍摄登记的**拍摄剪辑实操指导**，在v2重判触发时辅助判断改稿是否影响了拍摄可行性。两者组合形成"视听语言理论 + 拍摄剪辑实操"的拍摄指导体系。

### 联动时机

1. 用户登记拍摄完成时（触发词：拍了/shot/已拍/录完了/拍摄完成/拍好了）
2. Phase 2"建 video folder + 询问稿子一致性"时，加载2个视听相关子文件
3. Phase 3"写 videos/<id>/script.md + 触发v2预测"时，引用2个文件的内容辅助判断改稿是否影响视听元素
4. 当 diff ≥ 30% 触发 v2 重判时，引用 `audiovisual.md` 和 `shooting-editing.md` 辅助判断改稿对拍摄的影响
