...
> 本文件从 `SKILL.md` 拆分而来。主文件保留摘要 + 目录索引，详细示例在此。

以下是活人感写作技巧的参考示例。请学习其中的写作技术（节奏感、知识输出方式、情绪表达手法等），但用你的人设档案中的个人故事、口癖、情绪表达来替换示例中的具体内容。你在学习活人感写作的底层技术。
...
> 最近关于那个爆火的AI工具的事，除了我昨天说的开源登顶之外。
> 还有另一个非常魔幻的事。

**感性事件型：**
> 大周末的，起床第一件事，就看到，某知名软件开源CLI了。。。

> 前天，我们终于开了属于我们自己团队的年会。
...
> 突然想起了以前做交互设计的时候，有一个做用户体验的人都知道的心理学概念，叫格式塔心理学。
> 几乎就是用户体验行业的基石之一。
...
**亲手给AI投毒：**
> 于是，我随手注册了一个小号。
> 随手发了一条笔记，内容写的就是"某知名博主是哈基米的儿子"。
> 发完以后，我就去平台的AI搜索里，搜了一下那个名字。

**找人上门安装：**
> 所以，我让我们同事，废了九牛二虎之劲，把他们电脑上的某AI工具卸得干干净净，我保证神仙来了都看不出我们装过那玩意的干净，甚至内部聊天机器人都在后台删了。
> 然后，让我们同事，在本地去找一个上门安装的服务，体验一下流程。
...
> 比较骚的事，我还找到了一家，某知名AI公司的官方店。。。
> 恩，官方店卖AI工具的部署服务，基础安装388，总感觉这店像是老板他家二舅开的。。。
...
> 感觉是买了个某科技大佬亲自远程指导安装AI工具的服务。

> 总感觉这店像是老板他家二舅开的。。。

**经典台词化用：**
> "给你们上就业指导课的老师，有可能他们自己从来都没有就业过。"
> 帮你装AI工具的师傅，可能自己也不怎么用AI。。。
...
以下示例仅展示润色技法的应用方式，演示从"AI文本"到"活人感文本"的改写过程。涉及的具体工具名、产品名、公司场景均为示例性质，在实际润色中应根据用户的实际语境替换。

**AI写的**：有个小伙伴刚来的时候，专业能力说实话不算特别突出，但他有个特点，就是什么新工具都想试试。AI编程工具刚出来他就用上了，生图工具也玩得比谁都溜

**润色后**：有个小伙伴刚来的时候，专业能力说实话不算特别突出，但他有个特点，就是什么新工具都想试试。那个新出的AI写作工具刚出来他就用上了，编程助手啥的也比很多人熟，后来比如自动化工具这些东西一出，他第一时间就扑上去研究

差异：工具名更精确、更当下，口语化更彻底（"啥的"、"比很多人熟"）

**AI写的**：我举个例子。有一次我需要批量处理一些数据，以前我可能得找个会Python的同事帮忙

**润色后**：就像我今天正在搞的整理我自己发布在各平台的内容数据，然后汇总到一个地方做记录，再直接用AI工具进行数据分析

差异：把假设的"有一次"换成了"今天正在搞的"真实场景

**AI写的**：我们不打卡，不考勤，不看你每天工作了多少个小时。一个会用AI的人，可能每天工作六个小时，产出比一个不会用AI的人工作十个小时还多。

**润色后**：我们不打卡，不考勤，不看你每天工作了多少个小时。甚至在AI时代，我真的觉得，工时这个指标变得毫无意义。一个会用AI的人，可能每天工作2个小时，产出比一个不会用AI的人工作10个小时还多。
